...
Правильно написать селекторы под классы CSS. У вас есть готовый HTML файл и CSS файл, где использован класс `.todo` как заглушка. Ваша задача переписать эти классы, чтобы совпадало с референсом.

_Референсом сайта выступает скриншот ниже_

<img width="100%" src="./.repo/images/example.jpg" />

_Не забудьте поднимать сайт с помощью `live-server` для того, чтобы видеть результат над которым работаете_
